...
def test_laplacian_lmem(ctx_factory):
    ...
    # knl = lp.add_prefetch(knl, "G", ["i", "j", "m", "k"], default_tag="l.auto") # axis/argument indices on G  # noqa: E501
    # print(knl)
    # 1/0
...
def test_laplacian_lmem_ilp(ctx_factory):
    ...
    knl = lp.precompute(knl, "ur", np.float32, [0, 1, 2, "e_inner_inner"], default_tag="l.auto")  # noqa: E501
    knl = lp.precompute(knl, "us", np.float32, [0, 1, 2, "e_inner_inner"], default_tag="l.auto")  # noqa: E501
    knl = lp.precompute(knl, "ut", np.float32, [0, 1, 2, "e_inner_inner"], default_tag="l.auto")  # noqa: E501

    knl = lp.add_prefetch(knl, "G", ["m", "i", "j", "k", "e_inner_inner"], default_tag="l.auto")  # noqa: E501
